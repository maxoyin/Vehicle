...
import { VehicleTypeDTO } from '../service/dto/vehicle-type.dto';
import { VehicleTypeMapper } from '../service/mapper/vehicle-type.mapper';
import { VehicleTypeRepository } from '../repository/vehicle-type.repository';

const relationshipNames = [];
relationshipNames.push('assestClass');
