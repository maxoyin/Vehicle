...
/**
 * A VehicleMovementDTO object.
 */
export class VehicleMovementDTO extends BaseDTO {
  /**
  ...
  @IsNotEmpty()
  @ApiModelProperty({ description: 'retrievalAgentMaxId field' })
  ...
  @ApiModelProperty({ type: VehicleMovementHistoryDTO, isArray: true, description: 'vehicleMovementHistories relationship' })
  vehicleMovementHistories: VehicleMovementHistoryDTO[];
