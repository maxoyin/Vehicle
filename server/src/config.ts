...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'prospectService';
  ...
  'jhipster.mail.from' = 'prospectService@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'prospectService API';
  'jhipster.swagger.description' = 'prospectService API documentation';
  ...
  'eureka.instance.appname' = 'prospectService';
  'eureka.instance.instanceId' = 'prospectService:${random.value}';
  ...
  'cloud.config.name' = 'prospectService';
