...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_VEHICLEMODEL: 'vehicleModel/PARTIAL_UPDATE_VEHICLEMODEL',
...
export default (state: VehicleModelState = initialState, action): VehicleModelState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_VEHICLEMODEL):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_VEHICLEMODEL):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_VEHICLEMODEL):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IVehicleModel> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_VEHICLEMODEL,
