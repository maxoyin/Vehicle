...
export const VehicleDeleteDialog = (props: IVehicleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="prospectServiceApp.vehicle.delete.question">
        <Translate contentKey="prospectServiceApp.vehicle.delete.question" interpolate={{ id: vehicleEntity.id }}>
