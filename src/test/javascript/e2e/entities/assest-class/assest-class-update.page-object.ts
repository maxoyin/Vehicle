...
export default class AssestClassUpdatePage {
  pageTitle: ElementFinder = element(by.id('prospectServiceApp.assestClass.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  codeInput: ElementFinder = element(by.css('input#assest-class-code'));
  displayNameInput: ElementFinder = element(by.css('input#assest-class-displayName'));
  isDisplayOnInput: ElementFinder = element(by.css('input#assest-class-isDisplayOn'));
  descriptionInput: ElementFinder = element(by.css('input#assest-class-description'));
