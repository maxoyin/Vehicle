...
export class VehicleTypeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('prospectServiceApp.vehicleType.delete.question'));
...
export default class VehicleTypeComponentsPage {
  ...
  title: ElementFinder = element(by.id('vehicle-type-heading'));
  ...
  async deleteVehicleType() {
    ...
    expect(await vehicleTypeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/prospectServiceApp.vehicleType.delete.question/);
