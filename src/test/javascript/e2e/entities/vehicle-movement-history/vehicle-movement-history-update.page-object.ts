...
export default class VehicleMovementHistoryUpdatePage {
  pageTitle: ElementFinder = element(by.id('prospectServiceApp.vehicleMovementHistory.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  sourceSubCityIdInput: ElementFinder = element(by.css('input#vehicle-movement-history-sourceSubCityId'));
  destinationSubCityIdInput: ElementFinder = element(by.css('input#vehicle-movement-history-destinationSubCityId'));
  movementTypeSelect: ElementFinder = element(by.css('select#vehicle-movement-history-movementType'));
  retrivalAgentMaxIdInput: ElementFinder = element(by.css('input#vehicle-movement-history-retrivalAgentMaxId'));
  odometerReadingOutwardInput: ElementFinder = element(by.css('input#vehicle-movement-history-odometerReadingOutward'));
  odometerReadingInwardInput: ElementFinder = element(by.css('input#vehicle-movement-history-odometerReadingInward'));
  vehicleSelect: ElementFinder = element(by.css('select#vehicle-movement-history-vehicle'));
  vehicleMovementSelect: ElementFinder = element(by.css('select#vehicle-movement-history-vehicleMovement'));
  ...
  async setRetrivalAgentMaxIdInput(retrivalAgentMaxId) {
    await this.retrivalAgentMaxIdInput.sendKeys(retrivalAgentMaxId);
  }

  async getRetrivalAgentMaxIdInput() {
    return this.retrivalAgentMaxIdInput.getAttribute('value');
  }
  ...
  async enterData() {
    ...
    await waitUntilDisplayed(this.saveButton);
    await this.setRetrivalAgentMaxIdInput('retrivalAgentMaxId');
    expect(await this.getRetrivalAgentMaxIdInput()).to.match(/retrivalAgentMaxId/);
    await waitUntilDisplayed(this.saveButton);
