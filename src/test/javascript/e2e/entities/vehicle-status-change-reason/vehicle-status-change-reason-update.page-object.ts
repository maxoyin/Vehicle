...
export default class VehicleStatusChangeReasonUpdatePage {
  pageTitle: ElementFinder = element(by.id('prospectServiceApp.vehicleStatusChangeReason.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  codeInput: ElementFinder = element(by.css('input#vehicle-status-change-reason-code'));
  displayNameInput: ElementFinder = element(by.css('input#vehicle-status-change-reason-displayName'));
  descriptionInput: ElementFinder = element(by.css('input#vehicle-status-change-reason-description'));
  vehicleStatusSelect: ElementFinder = element(by.css('select#vehicle-status-change-reason-vehicleStatus'));
